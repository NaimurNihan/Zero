              ...
              {folderPopupOpen && (
                <>
                  ...
                  <div className="absolute right-0 top-10 z-[999] grid grid-cols-3 gap-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-2.5 shadow-xl" style={{width: "152px"}}>
                    {[
                      { short: "F5",  color: "#10b981", ...FOLDER_SETS[0] },
                      { short: "A3",  color: "#8b5cf6", ...FOLDER_SETS[1] },
                      { short: "A6",  color: "#f97316", ...FOLDER_SETS[2] },
                      { short: "A9",  color: "#3b82f6", ...FOLDER_SETS[3] },
                      { short: "A12", color: "#ec4899", ...FOLDER_SETS[4] },
                      { short: "A15", color: "#06b6d4", ...FOLDER_SETS[5] },
                    ].map((set) => (
                      <button
                        key={set.short}
